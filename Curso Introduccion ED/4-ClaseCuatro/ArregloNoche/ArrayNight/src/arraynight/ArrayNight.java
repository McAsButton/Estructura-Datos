...
//        showUniArray(vectorSort(ages));
        showUniArray(vectorSortInsert(ages));
...
//        System.out.println("\nEl promedio de las edades es: " + averageBiArray(ages));
    ...
    private static byte[] vectorSort(byte[] ages) {
        byte count = 1, aux = 0;
    ...
    private static byte[] vectorSortInsert(byte[] ages) {
        byte count = 1, i = 1, aux;
